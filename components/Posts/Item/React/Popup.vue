<template>
  <div
    class="absolute bottom-0 left-0 right-0 top-0 z-[50] flex h-full w-full touch-pan-y items-center justify-center bg-black/20 text-white backdrop-blur"
    data-cy="ebf125f8d23dbf48"
  ...
  >
    ...
    >
      ...
      >
        ...
        <BaseIconClose
          data-cy="post-reacting-user-list-close-button"
      ...
      >
        ...
        >
          ...
          <div
            class="truncate underline-offset-2 group-hover:underline"
            :data-cy="`post-reacting-user-${item.owner.id}`"
            :class="$device.isMobile ? 'max-w-24' : 'max-w-40'"
          >
            {{ item.owner?.name }}
          </div>
