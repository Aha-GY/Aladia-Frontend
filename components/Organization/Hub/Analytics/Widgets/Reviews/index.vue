<template>
  <OrganizationHubAnalyticsWidgetsWrap data-type="reviews-report" class="flex">
    ...
    <div class="ml-4 flex-1 text-sm">
      <OrganizationHubAnalyticsWidgetsHeader
        name="org.hub.task.manage.review"
      />
      <div class="mb-6 text-xl font-bold">240</div>
      <div class="mb-3 flex items-center justify-between">
        <div class="flex items-center gap-2 text-white/80">
          <div class="size-2 rounded-full bg-[#95c166]" />
          {{ $t('org.hub.analytics.reviews.positive') }}
        </div>
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-2 text-white/80">
          ...
          {{ $t('org.hub.analytics.reviews.negative') }}
        </div>
        <div class="text-white/50">123</div>
      </div>
    </div>
