    ...
    >
      ...
      >
        ...
        <div
          ...
          @click="showReacPopup"
        >
          More {{ userTypeData.length - users.length }}...
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  computed: {
    ...
    users() {
      console.log('users', this.userTypeData);
