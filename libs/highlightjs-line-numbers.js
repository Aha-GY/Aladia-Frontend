...
export function initLineNumbers() {
  ...
  function addStyles() {
    if (!d.querySelector('#initLineNumbers')) {
      var css = d.createElement('style');
      css.id = 'initLineNumbers';
  ...
  addStyles();
  return { lineNumbersBlock, initLineNumbersOnLoad };
}
