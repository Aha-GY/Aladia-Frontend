<template>
  <div class="relative">
    <Transition :name="direction" mode="out-in" class="z-[201] h-full w-full">
      <div v-if="store.isNewWebhook" class="relative">
        <div class="flex items-center justify-between">
          <div class="z-20 flex items-center py-2">
            <div
        ...
        <div
          ...
          class="hide-scrollbar flex w-full flex-col overflow-y-auto py-4"
        >
          <div>
            <div
              :class="{
              ...
              class="my-3 bg-[#060606] px-[1rem] text-xs text-[#555555]"
            >
              <p>
            ...
            <form class="space-y-[1.25rem]">
              ...
              <div class="relative">
                <BaseInput
                  ...
                  :required="
                    (isRequired || isEndPointUrlRequired) && !endpointURL
                  "
                  type="text"
          ...
          >
            ...
            <div class="mb-10 flex-1 pb-5">
              <div
                v-if="
                  !store.isLoadingGroupsEvents && store.eventsGroupsList.length
                "
          ...
          <div
            class="absolute bottom-0 left-0 right-0 mt-10 flex h-[2.875rem] w-full justify-end space-x-2 bg-[#0C0C0C] px-[0.75rem] py-[0.5rem] text-white"
          >
            <BaseButton
...
const direction = computed(() =>
  store.isNewWebhook ? 'slide-fade-left' : 'slide-fade-right',
);
const isChangedForm = computed(
  () =>
    title.value !== '' ||
    endpointURL.value !== '' ||
    store.selectedEventIds.length > 0,
);
