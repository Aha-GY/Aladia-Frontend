...
const clipPath = computed(() => {
  ...
  return `path('M 0,0 H ${props.width} V ${props.width} H 0 V 0 Z M ${offset},${offset} m -${radius},0 a ${radius},${radius} 0 1,0 ${radius * 2},0 a ${radius},${radius} 0 1,0 -${radius * 2},0 Z')`;
});
</script>
